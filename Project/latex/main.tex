...
\begin{minipage}[b]{.58\linewidth}
    ...
    \subcaption{Pie Chart of the attribute \textit{polysemy}}\label{fig:pie}
    \end{minipage}
...
%This behavior is well seen in Figure \ref{fig:eps}. 
...
\centering
    ...
    \begin{minipage}{0.49\linewidth}
            ...
            \subcaption{Hierarchical Clustering}\label{fig:boxcluhier}
    \end{minipage}
...
\adjustbox{max width=\textwidth}{%
    ...
    \end{tabular}
            ...
            \caption{Score values of DT for binary target variables, whereas the mean is weighted on the support.}\label{tab:class_scores}
...
We report the Confusion Matrix and the test scores directly in Figure \ref{aoa_multi}.

\begin{figure}[h]
  \begin{minipage}{.37\linewidth}
    \centering
    \includegraphics[width=0.9\textwidth]{aoa_multi_confusion_matrix.png}%
  \end{minipage}
  \hfil
...
age 10-12   &   0.51 &  0.43 &  0.47 &    86 \\\hline
...
age 10-12   &   0.66 &  0.30 &  0.42 &    86 \\\hline
%\textbf{macro avg}    &   0.43 &  0.42 &  0.42 &  1171 \\
...
\end{minipage}%
    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.9\linewidth]{valence_ROC_c.png}\subcaption{Valence}\label{fig:valroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.9\linewidth]{dominance_ROC_c.png}\subcaption{Dominance}\label{fig:domroc}
\end{minipage}
...
\end{minipage}%
    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.9\linewidth]{semsize_ROC_c.png}\subcaption{Semantic Size}\label{fig:semroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.9\linewidth]{masculinity_ROC_c.png}\subcaption{Masculinity}\label{fig:masroc}
\end{minipage}

\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.9\linewidth]{polysemy_ROC_c.png}\subcaption{Polysemy}\label{fig:polroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
...
5  &               (0.0\_Age\_of\_Acquisition, 0.0\_Length) &     3.0\_Familiarity &  2.11 &  0.88 &     10.00 &   467 \\\hline
