...
\adjustbox{max width=\textwidth}{%
    ...
    \hline
        & Arousal & Valence & Dominance & Familiarity & Size & Masculinity & Polysemy & Aoa & Perceivability\\\hline
        \textbf{Threshold} & 0.55 & 0.67 & 0.57 & 0.60 & 0.63 & 0.60 & 0.50 & 0.60 & 0.80\\
        \hline
    \end{tabular}
    }
...
\end{minipage}%
    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{valence_ROC.png}\subcaption{Valence}\label{fig:valroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{dominance_ROC.png}\subcaption{Dominance}\label{fig:domroc}
\end{minipage}
...
\end{minipage}%
    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{semsize_ROC.png}\subcaption{Semantic Size}\label{fig:semroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{masculinity_ROC.png}\subcaption{Masculinity}\label{fig:masroc}
\end{minipage}

\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{polysemy_ROC.png}\subcaption{Polysemy}\label{fig:polroc}
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
...
\end{minipage}    \hfil
\begin{minipage}[b]{.3\linewidth}
\centering\includegraphics[width=0.8\linewidth]{perceivability_ROC.png}\subcaption{Perceivability}\label{fig:perroc}
\end{minipage}
...
\adjustbox{max width=\textwidth}{%
    ...
    \hline
        ...
        \textbf{Accuracy} & 0.83 & 0.88 & 0.83 & 0.81 & 0.80 & 0.78 & 0.93 & 0.82 & 0.80\\\hline
        
        \textbf{Precision (0)} & 0.85 & 0.89 & 0.86 & 0.64 & 0.82 & 0.83 & 0.93 & 0.85 & 0.81\\
        \textbf{Precision (1)} & 0.75 & 0.83 & 0.70 & 0.88 & 0.70 & 0.57 & 0.00 & 0.73 & 0.80\\
        \textbf{Precision (mean)} & 0.82 & 0.87 & 0.82 & 0.82 & 0.76 & 0.69 & 0.87 & 0.82 & 0.80\\\hline
        
        \textbf{Recall (0)} & 0.94 & 0.95 & 0.92 & 0.69 & 0.94 & 0.88 & 1.00 & 0.92 & 0.90\\
        \textbf{Recall (1)} & 0.52 & 0.66 & 0.56 & 0.86 & 0.41 & 0.46 & 0.0 & 0.57 & 0.64\\
        \textbf{Recall (mean)} & 0.83 & 0.88 & 0.83 & 0.81 & 0.80 & 0.78 & 0.93 & 0.82 & 0.80\\\hline
        
        \textbf{F1 score (0)} & 0.89 & 0.92 & 0.89 & 0.67 & 0.87 & 0.85 & 0.96 & 0.88 & 0.85\\
        \textbf{F1 score (1)} & 0.61 & 0.74 & 0.62 & 0.87 & 0.51 & 0.51 & 0.00 & 0.64 & 0.71\\
        \textbf{F1 score (mean)} & 0.82 & 0.87 & 0.82 & 0.81 & 0.78 & 0.77 & 0.90 & 0.82 & 0.80\\\hline
        
    \end{tabular}
    }
            \caption{Score values for binary target variables}\label{tab:class_scores}

    \end{table}

Based on the ROCs, their area under the curves, the accuracy and the other scores, the most interesting parameter appears to be \textit{Valence}. In addition, we chose to focus on the variables \textit{Age of Acquisition} because we can also perform a multi-split analysis, and \textit{Polysemy} because it is already a binary variable. 
...
\begin{figure}[h]
  \begin{minipage}{.4\linewidth}
    \centering
    \includegraphics[width=\textwidth]{web_confusion_matrix.png}%
  \end{minipage}
  \begin{minipage}{.2\linewidth}
    \centering
\begin{tabular}{|r|c|c|c|c|}
...
{} &  Precision &    Recall &  F1-Score &      Support \\
\midrule
4.0          &   0.000000 &  0.000000 &  0.000000 &    12.000000 \\
5.0          &   0.462264 &  0.288235 &  0.355072 &   170.000000 \\
6.0          &   0.550907 &  0.742481 &  0.632506 &   532.000000 \\
7.0          &   0.533528 &  0.491935 &  0.511888 &   372.000000 \\
8.0          &   0.200000 &  0.012048 &  0.022727 &    83.000000 \\
9.0          &   0.000000 &  0.000000 &  0.000000 &     2.000000 \\
accuracy     &   0.536294 &  0.536294 &  0.536294 &     0.536294 \\
macro avg    &   0.291116 &  0.255783 &  0.253699 &  1171.000000 \\
weighted avg &   0.501058 &  0.536294 &  0.503129 &  1171.000000 \\
\bottomrule
\end{tabular}

  \end{minipage}
  
  \caption{Confusion Matrix and score values for Web Corpus Frequency} \label{wcf_multi}
\end{figure}
\end{comment}
...
\begin{comment}
ROC curves for the target variables can be seen in Figure \ref{fig:roc_randomforest}.

\begin{figure}[h]
\begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{rf_valence_roc.png}
    \subcaption{Valence}
\end{minipage}
\hfil
\begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{rf_pol_roc.png}
    \subcaption{Polysemy}
    \end{minipage}
    \hfil
    \begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{rf_aoa_roc.png}
    \subcaption{Age of Acquisition}
\end{minipage}

    \caption{ROC curves for target variables using Random Forest}
...
\begin{comment}
ROC curves for the target variables can be seen in Figure \ref{fig:roc_knn}.

\begin{figure}[h]
\begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{knn_val_roc.png}
    \subcaption{Valence}
\end{minipage}
\hfil
\begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{knn_pol_roc.png}
    \subcaption{Polysemy}
    \end{minipage}
    \hfil
    \begin{minipage}{0.32\linewidth}
    \centering
    \includegraphics[width=0.8\textwidth]{knn_aoa_roc.png}
    \subcaption{Age of Acquisition}
\end{minipage}

    \caption{ROC curves for target variables using KNN}
...
\adjustbox{max width=\textwidth}{%
    ...
    \hline
        ...
        \textbf{Precision (mean)} & 0.88 & 0.89 & 0.82\\\hline
        
        \textbf{Recall (0)} & 0.96 & 1.0 & 0.90\\
        \textbf{Recall (1)} & 0.67 & 0.01 & 0.68\\
        \textbf{Recall (mean)} & 0.88 & 0.93 & 0.82\\\hline
        
        \textbf{F1 score (0)} & 0.92 & 0.96 & 0.86\\
        \textbf{F1 score (1)} & 0.75 & 0.02 & 0.74\\
        \textbf{F1 score (mean)} & 0.87 & 0.90 & 0.82\\\hline
        
    \end{tabular}
    \label{tab:rf_scores}
    }
            \caption{Score values for Random Forest}
    \end{table}
    \end{minipage}
   \begin{minipage}{0.5\linewidth}
    \centering
...
\adjustbox{max width=\textwidth}{%
    ...
    \hline
        ...
        \textbf{Precision (mean)} & 0.88 & 0.94 & 0.84\\\hline
        
        \textbf{Recall (0)} & 0.98 & 0.99 & 0.95\\
        \textbf{Recall (1)} & 0.58 & 0.38 & 0.63\\
        \textbf{Recall (mean)} & 0.88 & 0.95 & 0.83\\\hline
        
        \textbf{F1 score (0)} & 0.92 & 0.97 & 0.87\\
        \textbf{F1 score (1)} & 0.71 & 0.49 & 0.73\\
        \textbf{F1 score (mean)} & 0.87 & 0.94 & 0.82\\\hline
        
    \end{tabular}
    }
            \caption{Score values for KNN}    \label{tab:knn_scores}

    \end{table}
\end{minipage}

\paragraph{Multi-split AoA} is a variable to consider in the KNN section, because this algorithm perform well with multi-split target variable. The analysis performed with K=14 is summarized in Figure \ref{aoa_multi_KNN}.
...
\begin{table}[h]
    ...
    True 0 & \cellcolor{Goldenrod}823 &  41 & \cellcolor{Goldenrod}1091 &  0 & \cellcolor{Goldenrod}663 &  70 & Decision \\\cline{1-7}\cline{1-7}
    True 1 &  104 & \cellcolor{YellowGreen}203 &  80 & \cellcolor{YellowGreen}0 &  159 & \cellcolor{YellowGreen}279 &  Tree\\\hline\hline
    
    
    True 0 & \cellcolor{Goldenrod}828 &  36 & \cellcolor{Goldenrod}1080 &  2 & \cellcolor{Goldenrod}660 &  73 & Random \bigstrut \\\cline{1-7}\cline{1-7}
    True 1 &  100 & \cellcolor{YellowGreen}207 &  79 & \cellcolor{YellowGreen}1 &  139 & \cellcolor{YellowGreen}299 & Forest \\\hline \hline
    
    
    True 0 & \cellcolor{Goldenrod}849 &   15 & \cellcolor{Goldenrod}1078 &  13 & \cellcolor{Goldenrod}694 &  39 & \multirow{2}[6]*{KNN} \bigstrut \\\cline{1-7}\cline{1-7}
    True 1 &  129 & \cellcolor{YellowGreen}178 &  50 & \cellcolor{YellowGreen}30 &  162 &\cellcolor{YellowGreen} 276 & \\\hline \hline
